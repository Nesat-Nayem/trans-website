      ...
      <div className="container">
        ...
        <div className="privacy-wrapper">
          ...
          <ul>
            ...
            <li>No money will be cancelled once the user makes the booking.</li>
            <li>Any additional package will be charged extra</li>
            <li>
              Any item marked as a free transition by Trans23 will be counted as
          ...
          <ul>
            ...
            <li>
              ...
              transition. The cost of Trip 1 and Trip 2 will be at the client's
              scope. Trip 1 – Booking location to a hub. Trip 2 –
            ...
            <li>
              Any document is missing during the inspection, Trans23 will not be
              responsible for the loss or any damage to the vehicle.
            </li>
          </ul>
          <h4>Fragile item</h4>
          <ul>
          ...
          <ul>
            ...
            <li>
              ...
              Trans23 will provide the charges with all the terms and conditions
              in one working day.
            </li>
            <li>
            ...
            <li>
              Customer extends any tenure will be charged separately at the time
              of an extension.
            </li>
          </ul>
          <h4>Warehouse:</h4>
          <ul>
            <li>
              The client using a warehouse shall share the delivery point in the
              booking agreement.
            </li>
            <li>
              If the client wants to extend the timeline, then the client has to
              inform us in advance in two days. Otherwise, Trans23 will deliver
              automatically at the end of the tenure.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>Trans23 will register a claim within 12hrs after delivery.</li>
          </ul>
          <h4>Claim:</h4>
          <ul>
            <li>
            ...
            <li>
              We will count free-of-cost transportation if the current valuation
              of the item goes less than equal to rs.50.
            </li>
            <li>
              The client has to claim their damage within 24 hrs after delivery.
              After 24 hrs, Trans23 will decide on the claim settlement.
            </li>
            <li>
          ...
          <ul>
            <li>
              ...
              However, it is the responsibility of insurance company to deliver
              the needful to their client.
            </li>
            <li>Any claim shall proceed as per insurance guidelines.</li>
            <li>
              Insurance is must for transporting vehicle. Therefore claim shall
              not be granted without insurance.
            </li>
          </ul>
        </div>
      </div>
